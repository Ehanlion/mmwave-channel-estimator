...
% Unit-modulus RF beamformers; random baseband, normalized
...
for m=1:M
    ...
    % Random baseband then power-normalize overall precoder such that ||F_RF*F_BB||_F^2 = Ns
    ...
    % Combiner baseband: simple semi-unitary via QR of random matrix
